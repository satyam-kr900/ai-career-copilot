...
export default function CareerRoadmapPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      <Header title="Personalized 7 / 30 / 60-Day Career Roadmap" />

      <div className="px-6 space-y-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-2">
          <h3 className="font-bold text-slate-100 text-sm flex items-center gap-2">
            <Map className="w-4 h-4 text-indigo-400" /> Targeted Skill Acquisition Schedule
          </h3>
          ...
          <div className="bg-slate-900 border border-indigo-500/30 rounded-2xl p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="font-bold text-indigo-400 text-sm flex items-center gap-2">
                <Calendar className="w-4 h-4" /> 7-Day Quick Start
              </span>
          ...
          <div className="bg-slate-900 border border-cyan-500/30 rounded-2xl p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="font-bold text-cyan-400 text-sm flex items-center gap-2">
                <Clock className="w-4 h-4" /> 30-Day Mid-Term Goal
              </span>
          ...
          <div className="bg-slate-900 border border-emerald-500/30 rounded-2xl p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <span className="font-bold text-emerald-400 text-sm flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4" /> 60-Day Mastery
              </span>
